    ...
    <div className="card">
      <div className="content">
        ...
        <div className="description">
          Writing contracts as code is the best way to precisely define its content, and avoid the ambiguity of natural lenguage.
          Create contracts from scratch or use a template from our gallery, such as Terms of Service, Creative Commons or Partner Agreement. Fill in the necessary data using autogenerated forms.
    ...
    <div className="card">
      <div className="content">
        ...
        <div className="description">
          ...
          Easily know who needs to do what and when and receive reminders of your next commitments. Record digital evidence of contract compliance in an inmutable log.
